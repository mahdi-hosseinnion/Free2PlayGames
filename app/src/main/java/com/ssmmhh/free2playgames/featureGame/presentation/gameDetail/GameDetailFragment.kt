...
import com.ssmmhh.free2playgames.featureGame.presentation.util.TextViewCollapsingAnimation
import com.ssmmhh.free2playgames.featureGame.presentation.util.setVisibilityToVisible
...
class GameDetailFragment : Fragment() {
    ...
    private fun setGameDetailValuesToTextViews(gameDetail: GameDetail) {
        // set image
        imagesViewPagerAdapter.submitNewData(
            buildList {
